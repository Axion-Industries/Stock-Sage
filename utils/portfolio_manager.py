...
class PortfolioManager:
    ...
    def add_transaction(self, symbol, action, shares, price):
        ...
        if symbol not in portfolio:
            portfolio[symbol] = {'shares': 0, 'avg_cost': 0, 'total_cost': 0}
        ...
        if action == 'buy':
            ...
            if portfolio[symbol]['shares'] >= shares:
                ...
                if portfolio[symbol]['shares'] == 0:
                    ...
                    portfolio[symbol]['total_cost'] = portfolio[symbol]['shares'] * portfolio[symbol]['avg_cost']
    ...
    def remove_holding(self, symbol):
        ...
        if symbol in portfolio:
            del portfolio[symbol]
            st.session_state[self.portfolio_key] = portfolio
            # Remove from database would go here
        return True
